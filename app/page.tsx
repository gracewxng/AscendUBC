    ...
    <div className="min-h-screen bg-gray-100 font-sans">
      ...
      <section className="py-16 bg-white px-6">
        ...
        <div className="mt-8 flex flex-col md:flex-row items-center md:items-start md:justify-center space-y-4 md:space-y-0 md:space-x-12">
          ...
          <p>
            Our primary vision is to enhance the presence, influence, and visibility of current and future Pan-Asian leadership in our community through professional networking, mentorship, and internship opportunities.
            <br />

            <br />
            We want to create a more sustainable and inclusive path towards leadership diversity and empower diverse business leaders with the resources to unlock their potential.
          </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-100 text-center px-6">
        ...
        <div className="mt-8 flex flex-col md:flex-row justify-center gap-6">
          ...
          <div className="bg-gray-200 rounded-2xl p-6 shadow-md w-full max-w-sm flex flex-col items-center h-48">
            <h3 className="font-semibold text-lg text-black">INTERNSHIP OPPORTUNITIES</h3>
            <div className="w-10 h-0.5 bg-black my-2"></div>
            <p className="text-gray-700 text-sm text-center overflow-auto">
              Build your work experience through internships with Ascend and its partners.
            </p>
          ...
          <div className="bg-gray-200 rounded-2xl p-6 shadow-md w-full max-w-sm flex flex-col items-center h-48">
            ...
            <div className="w-10 h-0.5 bg-black my-2"></div>
            <p className="text-gray-700 text-sm text-center overflow-auto">
              A chance to join a diverse and inclusive network of professionals at banking, accounting, and consulting firms across Canada.
            </p>
            <a href="#" className="text-black mt-4 inline-flex items-center space-x-1">
              {/* <span>learn more</span>
              <span>→</span> */}
          ...
          <div className="bg-gray-200 rounded-2xl p-6 shadow-md w-full max-w-sm flex flex-col items-center h-48">
            ...
            <div className="w-10 h-0.5 bg-black my-2"></div>
            <p className="text-gray-700 text-sm text-center overflow-auto">
              A one-on-one coaching program with industry professionals aimed specifically at UBC students.
            </p>
            <a href="#" className="text-black mt-4 inline-flex items-center space-x-1">
              {/* <span>learn more</span>
              <span>→</span> */}
